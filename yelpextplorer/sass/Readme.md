...
folder are mapped to the application's root namespace, 'YelpExtplorer'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "YelpExtplorer"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'YelpExtplorer' in the same way
as `"YelpExtplorer/sass/src"`.
